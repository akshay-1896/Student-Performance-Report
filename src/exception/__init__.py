...
class MyException(Exception):
    """
    Custom exception class for handling errors in the Student Performance Predictor Application.
    """
    def __init__(self, error_message: str, error_detail: sys):
        """
        Initializes the StudentPerformanceException with a detailed error message.
